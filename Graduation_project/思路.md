...
通过迭代重排序元素稀疏权，得到块态权重稀疏性
11. Tetris: Tile-matching the tremendous irregular sparsity 2018 220

分组加权并用小值剪枝，充分利用了单指令多数据（SIMD）单元的数据长度
12. Scalpel: CustomizingDNN pruning to the underlying hardwareparallelism 

13. Pruning filters for efficientConvNets 2016 200
