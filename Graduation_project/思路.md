...
使用Tucker decomposition。
| Features | Training ratios | Training ratios | 
| :---- | :----: | :----: |
|  | 10% | 20% |
| AlexNet | 0.747266  | 0.785357  |
| VGGNet（VGG-11） | 0.831429 | 0.882381 |
...
res18:p@1:90.53 p@5:99.16 

res101:p@1:92.09  p@5:99.49 

res101 训练 res18:prec@1:90.93 prec@5:99.28 
## 5.4 实验结果
### 5.4.3 实验结果比较
